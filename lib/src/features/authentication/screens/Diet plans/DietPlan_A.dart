...
class Dietplan_A extends StatelessWidget {
  const Dietplan_A({Key? key}) : super(key: key);
...
class PlanA extends StatefulWidget {
  const PlanA({Key? key}) : super(key: key);

  @override
  State<PlanA> createState() => _NutritionStateA();
}

class _NutritionStateA extends State<PlanA> {
